...
<html>
    ...
    <body>
      ...
      <div class="container-fluid">
        ...
        <div class= "p-2">Target name</div> <input type="text" name="name"><br>
        <div class= "p-2">Date of First Mission</div> <input type="date" name="first_missions"><br>
        <div class= "p-2">Type of Mission</div> <input type="text" name="missions"><br>
        <div class= "p-2">Number of Mission:</div> <input type="text" name="target_num"><br>
