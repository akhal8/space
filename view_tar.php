...
<html>
    ...
    <!-- creating row and column class for the table space and text center to move the text center-->
    <div class="row">
    ...
    <table class="table table-sm p-2 text-center">
      ...
      <th scope="col p-2">Number of Mission</th>
      <th scope="col p-2">Target Number</th>
    </tr>
    ...
    echo "<tr><td>".$tb_row["id"]. "</td><td>" . $tb_row["name"]. "</td><td>" . $tb_row["first_mission"]. "</td><td>" . $tb_row["type"]. 
    "</td><td>". $tb_row ["no_missions"]."</td><td>". $tb_row["no_missions"]. "</td></tr>";
    }
    }  
